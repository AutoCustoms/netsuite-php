...
class AsyncInitializeListRequest {
     ...
     */
    protected array $initializeRecord;
     ...
     * @return AsyncInitializeListRequest
     */
    public function setInitializeRecord(InitializeRecord $initializeRecord): AsyncInitializeListRequest
    {
     ...
     */
    public function getInitializeRecord(): array
    {
