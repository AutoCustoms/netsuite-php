...
class CashRefundSalesTeamList {
     ...
     */
    public function setSalesTeam(CashRefundSalesTeam $salesTeam): CashRefundSalesTeamList
    {
     ...
     * @return CashRefundSalesTeamList
     */
    public function setReplaceAll(bool $replaceAll): CashRefundSalesTeamList
    {
