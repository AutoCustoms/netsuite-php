...
class CampaignDirectMailList {
     ...
     */
    protected array $campaignDirectMail;
     ...
     */
    public function setCampaignDirectMail(CampaignDirectMail $campaignDirectMail): CampaignDirectMailList
    {
     ...
     */
    public function getCampaignDirectMail(): array
    {
     ...
     * @return CampaignDirectMailList
     */
    public function setReplaceAll(bool $replaceAll): CampaignDirectMailList
    {
