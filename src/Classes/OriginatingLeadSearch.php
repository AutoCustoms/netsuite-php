...
class OriginatingLeadSearch extends SearchRecord {
     ...
     */
    public function setBasic(OriginatingLeadSearchBasic $basic): OriginatingLeadSearch
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): OriginatingLeadSearchBasic
    {
        return $this->basic;
    }
     ...
     * @return OriginatingLeadSearch
     */
    public function setCustomSearchJoin(CustomSearchJoin $customSearchJoin): OriginatingLeadSearch
    {
