...
class DepositApplicationApplyList {
     ...
     */
    public function setApply(DepositApplicationApply $apply): DepositApplicationApplyList
    {
        $this->apply[] = $apply;
        return $this;
    }
     ...
     * @return DepositApplicationApplyList
     */
    public function setReplaceAll(bool $replaceAll): DepositApplicationApplyList
    {
