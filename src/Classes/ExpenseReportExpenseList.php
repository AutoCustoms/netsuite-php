...
class ExpenseReportExpenseList {
     ...
     */
    public function setExpense(ExpenseReportExpense $expense): ExpenseReportExpenseList
    {
     ...
     * @return ExpenseReportExpenseList
     */
    public function setReplaceAll(bool $replaceAll): ExpenseReportExpenseList
    {
