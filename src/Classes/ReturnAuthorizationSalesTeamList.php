...
class ReturnAuthorizationSalesTeamList {
     ...
     */
    public function setSalesTeam(ReturnAuthorizationSalesTeam $salesTeam): ReturnAuthorizationSalesTeamList
    {
     ...
     * @return ReturnAuthorizationSalesTeamList
     */
    public function setReplaceAll(bool $replaceAll): ReturnAuthorizationSalesTeamList
    {
