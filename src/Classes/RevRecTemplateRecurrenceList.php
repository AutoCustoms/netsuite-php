...
class RevRecTemplateRecurrenceList {
     ...
     */
    protected array $revRecTemplateRecurrence;
     ...
     */
    public function setRevRecTemplateRecurrence(RevRecTemplateRecurrence $revRecTemplateRecurrence): RevRecTemplateRecurrenceList
    {
     ...
     */
    public function getRevRecTemplateRecurrence(): array
    {
     ...
     * @return RevRecTemplateRecurrenceList
     */
    public function setReplaceAll(bool $replaceAll): RevRecTemplateRecurrenceList
    {
