...
class CashRefundSalesTeam {
     ...
     */
    public function setEmployee(RecordRef $employee): CashRefundSalesTeam
    {
     ...
     * @return CashRefundSalesTeam
     */
    public function setSalesRole(RecordRef $salesRole): CashRefundSalesTeam
    {
     ...
     * @return CashRefundSalesTeam
     */
    public function setIsPrimary(bool $isPrimary): CashRefundSalesTeam
    {
     ...
     * @return CashRefundSalesTeam
     */
    public function setContribution(float $contribution): CashRefundSalesTeam
    {
