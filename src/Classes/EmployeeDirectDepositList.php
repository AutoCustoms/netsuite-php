...
class EmployeeDirectDepositList {
     ...
     */
    protected array $employeeDirectDeposit;
     ...
     */
    public function setEmployeeDirectDeposit(EmployeeDirectDeposit $employeeDirectDeposit): EmployeeDirectDepositList
    {
     ...
     */
    public function getEmployeeDirectDeposit(): array
    {
     ...
     * @return EmployeeDirectDepositList
     */
    public function setReplaceAll(bool $replaceAll): EmployeeDirectDepositList
    {
