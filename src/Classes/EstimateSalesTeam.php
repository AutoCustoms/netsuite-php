...
class EstimateSalesTeam {
     ...
     */
    public function setEmployee(RecordRef $employee): EstimateSalesTeam
    {
     ...
     * @return EstimateSalesTeam
     */
    public function setSalesRole(RecordRef $salesRole): EstimateSalesTeam
    {
     ...
     * @return EstimateSalesTeam
     */
    public function setIsPrimary(bool $isPrimary): EstimateSalesTeam
    {
     ...
     * @return EstimateSalesTeam
     */
    public function setContribution(float $contribution): EstimateSalesTeam
    {
