...
class PaycheckPaySummaryList {
     ...
     */
    protected array $paycheckPaySummary;
     ...
     */
    public function setPaycheckPaySummary(PaycheckPaySummary $paycheckPaySummary): PaycheckPaySummaryList
    {
     ...
     */
    public function getPaycheckPaySummary(): array
    {
     ...
     * @return PaycheckPaySummaryList
     */
    public function setReplaceAll(bool $replaceAll): PaycheckPaySummaryList
    {
