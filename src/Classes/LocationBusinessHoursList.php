...
class LocationBusinessHoursList {
     ...
     */
    protected array $locationBusinessHours;
     ...
     */
    public function setLocationBusinessHours(LocationBusinessHours $locationBusinessHours): LocationBusinessHoursList
    {
     ...
     */
    public function getLocationBusinessHours(): array
    {
     ...
     * @return LocationBusinessHoursList
     */
    public function setReplaceAll(bool $replaceAll): LocationBusinessHoursList
    {
