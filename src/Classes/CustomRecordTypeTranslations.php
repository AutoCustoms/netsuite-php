...
class CustomRecordTypeTranslations {
     ...
     */
    public function setLocale(Language $locale): CustomRecordTypeTranslations
    {
        $this->locale = $locale;
        return $this;
    }
     ...
     * @return CustomRecordTypeTranslations
     */
    public function setLocaleDescription(string $localeDescription): CustomRecordTypeTranslations
    {
     ...
     * @return CustomRecordTypeTranslations
     */
    public function setName(string $name): CustomRecordTypeTranslations
    {
        $this->name = $name;
        return $this;
    }
