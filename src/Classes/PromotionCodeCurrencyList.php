...
class PromotionCodeCurrencyList {
     ...
     */
    public function setCurrency(PromotionCodeCurrency $currency): PromotionCodeCurrencyList
    {
     ...
     * @return PromotionCodeCurrencyList
     */
    public function setReplaceAll(bool $replaceAll): PromotionCodeCurrencyList
    {
