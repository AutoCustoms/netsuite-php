...
class SerializedAssemblyItemBillOfMaterialsList {
     ...
     */
    protected array $serializedAssemblyItemBillOfMaterials;
     ...
     */
    public function setSerializedAssemblyItemBillOfMaterials(SerializedAssemblyItemBillOfMaterials $serializedAssemblyItemBillOfMaterials): SerializedAssemblyItemBillOfMaterialsList
    {
     ...
     */
    public function getSerializedAssemblyItemBillOfMaterials(): array
    {
     ...
     * @return SerializedAssemblyItemBillOfMaterialsList
     */
    public function setReplaceAll(bool $replaceAll): SerializedAssemblyItemBillOfMaterialsList
    {
