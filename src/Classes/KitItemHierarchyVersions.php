...
class KitItemHierarchyVersions {
     ...
     */
    public function setIsIncluded(bool $isIncluded): KitItemHierarchyVersions
    {
     ...
     * @return KitItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): KitItemHierarchyVersions
    {
     ...
     * @return KitItemHierarchyVersions
     */
    public function setStartDate(string $startDate): KitItemHierarchyVersions
    {
     ...
     * @return KitItemHierarchyVersions
     */
    public function setEndDate(string $endDate): KitItemHierarchyVersions
    {
     ...
     * @return KitItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): KitItemHierarchyVersions
    {
