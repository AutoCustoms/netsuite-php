...
class PaycheckJournalEmployeeTaxList {
     ...
     */
    protected array $paycheckJournalEmployeeTax;
     ...
     */
    public function setPaycheckJournalEmployeeTax(PaycheckJournalEmployeeTax $paycheckJournalEmployeeTax): PaycheckJournalEmployeeTaxList
    {
     ...
     */
    public function getPaycheckJournalEmployeeTax(): array
    {
     ...
     * @return PaycheckJournalEmployeeTaxList
     */
    public function setReplaceAll(bool $replaceAll): PaycheckJournalEmployeeTaxList
    {
