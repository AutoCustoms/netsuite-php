...
class VendorTaxRegistration {
     ...
     */
    public function setNexusCountry(Country $nexusCountry): VendorTaxRegistration
    {
     ...
     * @return VendorTaxRegistration
     */
    public function setNexus(RecordRef $nexus): VendorTaxRegistration
    {
        $this->nexus = $nexus;
        return $this;
    }
     ...
     * @return VendorTaxRegistration
     */
    public function setAddress(RecordRef $address): VendorTaxRegistration
    {
     ...
     * @return VendorTaxRegistration
     */
    public function setTaxRegistrationNumber(string $taxRegistrationNumber): VendorTaxRegistration
    {
     ...
     * @return VendorTaxRegistration
     */
    public function setId(int $id): VendorTaxRegistration
    {
        $this->id = $id;
        return $this;
    }
