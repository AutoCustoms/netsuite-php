...
class JobTypeSearch extends SearchRecord {
     ...
     */
    public function setBasic(JobTypeSearchBasic $basic): JobTypeSearch
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): JobTypeSearchBasic
    {
        return $this->basic;
    }
     ...
     * @return JobTypeSearch
     */
    public function setUserJoin(EmployeeSearchBasic $userJoin): JobTypeSearch
    {
