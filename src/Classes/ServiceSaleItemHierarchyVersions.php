...
class ServiceSaleItemHierarchyVersions {
    /**
     * @var bool
     */
     ...
     */
    public function setIsIncluded(bool $isIncluded): ServiceSaleItemHierarchyVersions
    {
     ...
     * @return ServiceSaleItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): ServiceSaleItemHierarchyVersions
    {
     ...
     * @return ServiceSaleItemHierarchyVersions
     */
    public function setStartDate(string $startDate): ServiceSaleItemHierarchyVersions
    {
     ...
     * @return ServiceSaleItemHierarchyVersions
     */
    public function setEndDate(string $endDate): ServiceSaleItemHierarchyVersions
    {
     ...
     * @return ServiceSaleItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): ServiceSaleItemHierarchyVersions
    {
