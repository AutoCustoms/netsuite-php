...
class ItemAccountingBookDetailList {
     ...
     */
    protected array $itemAccountingBookDetail;
     ...
     */
    public function setItemAccountingBookDetail(ItemAccountingBookDetail $itemAccountingBookDetail): ItemAccountingBookDetailList
    {
     ...
     */
    public function getItemAccountingBookDetail(): array
    {
     ...
     * @return ItemAccountingBookDetailList
     */
    public function setReplaceAll(bool $replaceAll): ItemAccountingBookDetailList
    {
