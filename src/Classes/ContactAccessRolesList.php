...
class ContactAccessRolesList {
     ...
     */
    public function setContactRoles(ContactAccessRoles $contactRoles): ContactAccessRolesList
    {
     ...
     * @return ContactAccessRolesList
     */
    public function setReplaceAll(bool $replaceAll): ContactAccessRolesList
    {
