...
class OtherChargeSaleItemHierarchyVersions {
    /**
     * @var bool
     */
     ...
     */
    public function setIsIncluded(bool $isIncluded): OtherChargeSaleItemHierarchyVersions
    {
     ...
     * @return OtherChargeSaleItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): OtherChargeSaleItemHierarchyVersions
    {
     ...
     * @return OtherChargeSaleItemHierarchyVersions
     */
    public function setStartDate(string $startDate): OtherChargeSaleItemHierarchyVersions
    {
     ...
     * @return OtherChargeSaleItemHierarchyVersions
     */
    public function setEndDate(string $endDate): OtherChargeSaleItemHierarchyVersions
    {
     ...
     * @return OtherChargeSaleItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): OtherChargeSaleItemHierarchyVersions
    {
