...
class InventoryNumberLocationsList {
     ...
     */
    public function setLocations(InventoryNumberLocations $locations): InventoryNumberLocationsList
    {
     ...
     * @return InventoryNumberLocationsList
     */
    public function setReplaceAll(bool $replaceAll): InventoryNumberLocationsList
    {
