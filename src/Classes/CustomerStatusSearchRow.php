...
class CustomerStatusSearchRow extends SearchRow {
     ...
     */
    public function setBasic(CustomerStatusSearchRowBasic $basic): CustomerStatusSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): CustomerStatusSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return CustomerStatusSearchRow
     */
    public function setUserJoin(EmployeeSearchRowBasic $userJoin): CustomerStatusSearchRow
    {
