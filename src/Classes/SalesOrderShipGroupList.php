...
class SalesOrderShipGroupList {
     ...
     */
    public function setShipGroup(TransactionShipGroup $shipGroup): SalesOrderShipGroupList
    {
     ...
     * @return SalesOrderShipGroupList
     */
    public function setReplaceAll(bool $replaceAll): SalesOrderShipGroupList
    {
