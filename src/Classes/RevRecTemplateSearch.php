...
class RevRecTemplateSearch extends SearchRecord {
     ...
     */
    public function setBasic(RevRecTemplateSearchBasic $basic): RevRecTemplateSearch
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): RevRecTemplateSearchBasic
    {
        return $this->basic;
    }
     ...
     * @return RevRecTemplateSearch
     */
    public function setUserJoin(EmployeeSearchBasic $userJoin): RevRecTemplateSearch
    {
