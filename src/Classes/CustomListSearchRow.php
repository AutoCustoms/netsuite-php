...
class CustomListSearchRow extends SearchRow {
     ...
     */
    public function setBasic(CustomListSearchRowBasic $basic): CustomListSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): CustomListSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return CustomListSearchRow
     */
    public function setUserJoin(EmployeeSearchRowBasic $userJoin): CustomListSearchRow
    {
