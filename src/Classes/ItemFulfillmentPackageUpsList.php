...
class ItemFulfillmentPackageUpsList {
     ...
     */
    public function setPackageUps(ItemFulfillmentPackageUps $packageUps): ItemFulfillmentPackageUpsList
    {
     ...
     */
    public function getPackageUps(): array
    {
     ...
     * @return ItemFulfillmentPackageUpsList
     */
    public function setReplaceAll(bool $replaceAll): ItemFulfillmentPackageUpsList
    {
