...
class Language {
    ...
    const _armenian = "_armenian";
    const _bengali = "_bengali";
    const _bosnian = "_bosnian";
    ...
    const _dutch = "_dutch";
    const _englishAu = "_englishAu";
    const _englishCa = "_englishCa";
    const _englishInternational = "_englishInternational";
    const _englishUK = "_englishUK";
    const _englishUS = "_englishUS";
    const _estonian = "_estonian";
    const _filipino = "_filipino";
    const _finnish = "_finnish";
    const _frenchCanada = "_frenchCanada";
    const _frenchFrance = "_frenchFrance";
    const _german = "_german";
    const _greek = "_greek";
    const _gujarati = "_gujarati";
