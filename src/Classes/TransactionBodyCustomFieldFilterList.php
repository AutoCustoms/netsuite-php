...
class TransactionBodyCustomFieldFilterList {
     ...
     */
    public function setFilter(TransactionBodyCustomFieldFilter $filter): TransactionBodyCustomFieldFilterList
    {
        $this->filter[] = $filter;
        return $this;
    }
     ...
     * @return TransactionBodyCustomFieldFilterList
     */
    public function setReplaceAll(bool $replaceAll): TransactionBodyCustomFieldFilterList
    {
