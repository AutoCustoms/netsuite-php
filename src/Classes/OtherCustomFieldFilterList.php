...
class OtherCustomFieldFilterList {
     ...
     */
    public function setFilter(OtherCustomFieldFilter $filter): OtherCustomFieldFilterList
    {
        $this->filter[] = $filter;
        return $this;
    }
     ...
     * @return OtherCustomFieldFilterList
     */
    public function setReplaceAll(bool $replaceAll): OtherCustomFieldFilterList
    {
