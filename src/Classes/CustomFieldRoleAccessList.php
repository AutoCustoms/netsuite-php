...
class CustomFieldRoleAccessList {
     ...
     */
    public function setRoleAccess(CustomFieldRoleAccess $roleAccess): CustomFieldRoleAccessList
    {
     ...
     * @return CustomFieldRoleAccessList
     */
    public function setReplaceAll(bool $replaceAll): CustomFieldRoleAccessList
    {
