...
class OpportunityCompetitorsList {
     ...
     */
    public function setCompetitors(OpportunityCompetitors $competitors): OpportunityCompetitorsList
    {
     ...
     * @return OpportunityCompetitorsList
     */
    public function setReplaceAll(bool $replaceAll): OpportunityCompetitorsList
    {
