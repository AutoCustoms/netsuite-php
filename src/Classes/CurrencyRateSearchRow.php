...
class CurrencyRateSearchRow extends SearchRow {
     ...
     */
    public function setBasic(CurrencyRateSearchRowBasic $basic): CurrencyRateSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): CurrencyRateSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return CurrencyRateSearchRow
     */
    public function setUserJoin(EmployeeSearchRowBasic $userJoin): CurrencyRateSearchRow
    {
