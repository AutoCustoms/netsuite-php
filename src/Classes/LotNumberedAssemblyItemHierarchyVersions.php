...
class LotNumberedAssemblyItemHierarchyVersions {
     ...
     */
    public function setIsIncluded(bool $isIncluded): LotNumberedAssemblyItemHierarchyVersions
    {
     ...
     * @return LotNumberedAssemblyItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): LotNumberedAssemblyItemHierarchyVersions
    {
     ...
     * @return LotNumberedAssemblyItemHierarchyVersions
     */
    public function setStartDate(string $startDate): LotNumberedAssemblyItemHierarchyVersions
    {
     ...
     * @return LotNumberedAssemblyItemHierarchyVersions
     */
    public function setEndDate(string $endDate): LotNumberedAssemblyItemHierarchyVersions
    {
     ...
     * @return LotNumberedAssemblyItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): LotNumberedAssemblyItemHierarchyVersions
    {
