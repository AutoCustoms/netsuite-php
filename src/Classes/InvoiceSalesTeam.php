...
class InvoiceSalesTeam {
     ...
     */
    public function setEmployee(RecordRef $employee): InvoiceSalesTeam
    {
     ...
     * @return InvoiceSalesTeam
     */
    public function setSalesRole(RecordRef $salesRole): InvoiceSalesTeam
    {
     ...
     * @return InvoiceSalesTeam
     */
    public function setIsPrimary(bool $isPrimary): InvoiceSalesTeam
    {
     ...
     * @return InvoiceSalesTeam
     */
    public function setContribution(float $contribution): InvoiceSalesTeam
    {
