...
class ItemFulfillmentPackageUspsList {
     ...
     */
    public function setPackageUsps(ItemFulfillmentPackageUsps $packageUsps): ItemFulfillmentPackageUspsList
    {
     ...
     */
    public function getPackageUsps(): array
    {
     ...
     * @return ItemFulfillmentPackageUspsList
     */
    public function setReplaceAll(bool $replaceAll): ItemFulfillmentPackageUspsList
    {
