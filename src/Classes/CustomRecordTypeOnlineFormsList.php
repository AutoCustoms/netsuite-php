...
class CustomRecordTypeOnlineFormsList {
     ...
     */
    public function setOnlineForms(CustomRecordTypeOnlineForms $onlineForms): CustomRecordTypeOnlineFormsList
    {
     ...
     */
    public function getOnlineForms(): array
    {
     ...
     * @return CustomRecordTypeOnlineFormsList
     */
    public function setReplaceAll(bool $replaceAll): CustomRecordTypeOnlineFormsList
    {
