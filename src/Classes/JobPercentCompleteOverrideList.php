...
class JobPercentCompleteOverrideList {
     ...
     */
    protected array $jobPercentCompleteOverride;
     ...
     */
    public function setJobPercentCompleteOverride(JobPercentCompleteOverride $jobPercentCompleteOverride): JobPercentCompleteOverrideList
    {
     ...
     */
    public function getJobPercentCompleteOverride(): array
    {
     ...
     * @return JobPercentCompleteOverrideList
     */
    public function setReplaceAll(bool $replaceAll): JobPercentCompleteOverrideList
    {
