...
class CustomerRefundDepositList {
     ...
     */
    protected array $customerRefundDeposit;
     ...
     */
    public function setCustomerRefundDeposit(CustomerRefundDeposit $customerRefundDeposit): CustomerRefundDepositList
    {
     ...
     */
    public function getCustomerRefundDeposit(): array
    {
     ...
     * @return CustomerRefundDepositList
     */
    public function setReplaceAll(bool $replaceAll): CustomerRefundDepositList
    {
