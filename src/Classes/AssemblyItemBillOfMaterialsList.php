...
class AssemblyItemBillOfMaterialsList {
     ...
     */
    protected array $assemblyItemBillOfMaterials;
     ...
     */
    public function setAssemblyItemBillOfMaterials(AssemblyItemBillOfMaterials $assemblyItemBillOfMaterials): AssemblyItemBillOfMaterialsList
    {
     ...
     */
    public function getAssemblyItemBillOfMaterials(): array
    {
     ...
     * @return AssemblyItemBillOfMaterialsList
     */
    public function setReplaceAll(bool $replaceAll): AssemblyItemBillOfMaterialsList
    {
