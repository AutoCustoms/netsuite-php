...
class GiftCertificateItemAuthCodesList {
     ...
     */
    public function setAuthCodes(GiftCertificateItemAuthCodes $authCodes): GiftCertificateItemAuthCodesList
    {
     ...
     * @return GiftCertificateItemAuthCodesList
     */
    public function setReplaceAll(bool $replaceAll): GiftCertificateItemAuthCodesList
    {
