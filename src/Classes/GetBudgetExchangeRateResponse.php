...
class GetBudgetExchangeRateResponse {
     ...
     */
    public function setGetBudgetExchangeRateResult(GetBudgetExchangeRateResult $getBudgetExchangeRateResult): GetBudgetExchangeRateResponse
    {
     ...
     */
    public function getGetBudgetExchangeRateResult(): GetBudgetExchangeRateResult
    {
