...
class WorkOrderIssueComponentList {
     ...
     */
    protected array $workOrderIssueComponent;
     ...
     */
    public function setWorkOrderIssueComponent(WorkOrderIssueComponent $workOrderIssueComponent): WorkOrderIssueComponentList
    {
     ...
     */
    public function getWorkOrderIssueComponent(): array
    {
     ...
     * @return WorkOrderIssueComponentList
     */
    public function setReplaceAll(bool $replaceAll): WorkOrderIssueComponentList
    {
