...
class AsyncDeleteListRequest {
     ...
     * @return AsyncDeleteListRequest
     */
    public function setBaseRef(BaseRef $baseRef): AsyncDeleteListRequest
    {
     ...
     * @return AsyncDeleteListRequest
     */
    public function setDeletionReason(DeletionReason $deletionReason): AsyncDeleteListRequest
    {
