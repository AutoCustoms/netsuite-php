...
class ManufacturingRoutingRoutingStepList {
     ...
     */
    protected array $manufacturingRoutingRoutingStep;
     ...
     */
    public function setManufacturingRoutingRoutingStep(ManufacturingRoutingRoutingStep $manufacturingRoutingRoutingStep): ManufacturingRoutingRoutingStepList
    {
     ...
     */
    public function getManufacturingRoutingRoutingStep(): array
    {
     ...
     * @return ManufacturingRoutingRoutingStepList
     */
    public function setReplaceAll(bool $replaceAll): ManufacturingRoutingRoutingStepList
    {
