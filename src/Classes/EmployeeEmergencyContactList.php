...
class EmployeeEmergencyContactList {
     ...
     */
    protected array $employeeEmergencyContact;
     ...
     */
    public function setEmployeeEmergencyContact(EmployeeEmergencyContact $employeeEmergencyContact): EmployeeEmergencyContactList
    {
     ...
     */
    public function getEmployeeEmergencyContact(): array
    {
     ...
     * @return EmployeeEmergencyContactList
     */
    public function setReplaceAll(bool $replaceAll): EmployeeEmergencyContactList
    {
