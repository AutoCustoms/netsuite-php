...
class PriceLevelSearchRow extends SearchRow {
     ...
     */
    public function setBasic(PriceLevelSearchRowBasic $basic): PriceLevelSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): PriceLevelSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return PriceLevelSearchRow
     */
    public function setUserJoin(EmployeeSearchRowBasic $userJoin): PriceLevelSearchRow
    {
