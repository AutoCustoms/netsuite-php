...
class CreditMemoSalesTeamList {
     ...
     */
    public function setSalesTeam(CreditMemoSalesTeam $salesTeam): CreditMemoSalesTeamList
    {
     ...
     * @return CreditMemoSalesTeamList
     */
    public function setReplaceAll(bool $replaceAll): CreditMemoSalesTeamList
    {
