...
class ContactAddressbookList {
     ...
     */
    public function setAddressbook(ContactAddressbook $addressbook): ContactAddressbookList
    {
     ...
     * @return ContactAddressbookList
     */
    public function setReplaceAll(bool $replaceAll): ContactAddressbookList
    {
