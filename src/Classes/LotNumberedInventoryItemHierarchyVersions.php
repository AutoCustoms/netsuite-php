...
class LotNumberedInventoryItemHierarchyVersions {
     ...
     */
    public function setIsIncluded(bool $isIncluded): LotNumberedInventoryItemHierarchyVersions
    {
     ...
     * @return LotNumberedInventoryItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): LotNumberedInventoryItemHierarchyVersions
    {
     ...
     * @return LotNumberedInventoryItemHierarchyVersions
     */
    public function setStartDate(string $startDate): LotNumberedInventoryItemHierarchyVersions
    {
     ...
     * @return LotNumberedInventoryItemHierarchyVersions
     */
    public function setEndDate(string $endDate): LotNumberedInventoryItemHierarchyVersions
    {
     ...
     * @return LotNumberedInventoryItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): LotNumberedInventoryItemHierarchyVersions
    {
