...
class GetServerTimeResponse {
     ...
     */
    public function setGetServerTimeResult(GetServerTimeResult $getServerTimeResult): GetServerTimeResponse
    {
     ...
     */
    public function getGetServerTimeResult(): GetServerTimeResult
    {
