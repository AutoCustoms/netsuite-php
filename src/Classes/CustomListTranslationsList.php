...
class CustomListTranslationsList {
     ...
     */
    public function setTranslations(CustomListTranslations $translations): CustomListTranslationsList
    {
     ...
     * @return CustomListTranslationsList
     */
    public function setReplaceAll(bool $replaceAll): CustomListTranslationsList
    {
