...
class PostingTransactionSummaryList {
     ...
     */
    protected array $postingTransactionSummary;
     ...
     */
    public function setPostingTransactionSummary(PostingTransactionSummary $postingTransactionSummary): PostingTransactionSummaryList
    {
     ...
     */
    public function getPostingTransactionSummary(): array
    {
