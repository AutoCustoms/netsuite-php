...
class SalesRoleSearch extends SearchRecord {
     ...
     */
    public function setBasic(SalesRoleSearchBasic $basic): SalesRoleSearch
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): SalesRoleSearchBasic
    {
        return $this->basic;
    }
     ...
     * @return SalesRoleSearch
     */
    public function setUserJoin(EmployeeSearchBasic $userJoin): SalesRoleSearch
    {
