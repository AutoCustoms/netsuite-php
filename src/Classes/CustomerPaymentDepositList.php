...
class CustomerPaymentDepositList {
     ...
     */
    public function setDeposit(CustomerPaymentDeposit $deposit): CustomerPaymentDepositList
    {
     ...
     * @return CustomerPaymentDepositList
     */
    public function setReplaceAll(bool $replaceAll): CustomerPaymentDepositList
    {
