...
class GetItemAvailabilityResponse {
     ...
     */
    public function setGetItemAvailabilityResult(GetItemAvailabilityResult $getItemAvailabilityResult): GetItemAvailabilityResponse
    {
     ...
     */
    public function getGetItemAvailabilityResult(): GetItemAvailabilityResult
    {
