...
class InventoryItemHierarchyVersions {
    /**
     * @var bool
     */
     ...
     */
    public function setIsIncluded(bool $isIncluded): InventoryItemHierarchyVersions
    {
     ...
     * @return InventoryItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): InventoryItemHierarchyVersions
    {
     ...
     * @return InventoryItemHierarchyVersions
     */
    public function setStartDate(string $startDate): InventoryItemHierarchyVersions
    {
     ...
     * @return InventoryItemHierarchyVersions
     */
    public function setEndDate(string $endDate): InventoryItemHierarchyVersions
    {
     ...
     * @return InventoryItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): InventoryItemHierarchyVersions
    {
