...
class RecurrenceDowMaskList {
     ...
     * @var RecurrenceDow
     */
    protected RecurrenceDow $recurrenceDowMask;
     ...
     */
    public function setRecurrenceDowMask(RecurrenceDow $recurrenceDowMask): RecurrenceDowMaskList
    {
     ...
     */
    public function getRecurrenceDowMask(): RecurrenceDow
    {
