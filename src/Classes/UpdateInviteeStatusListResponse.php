...
class UpdateInviteeStatusListResponse {
     ...
     */
    public function setWriteResponseList(WriteResponseList $writeResponseList): UpdateInviteeStatusListResponse
    {
     ...
     */
    public function getWriteResponseList(): WriteResponseList
    {
