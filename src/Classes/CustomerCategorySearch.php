...
class CustomerCategorySearch extends SearchRecord {
     ...
     */
    public function setBasic(CustomerCategorySearchBasic $basic): CustomerCategorySearch
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): CustomerCategorySearchBasic
    {
        return $this->basic;
    }
     ...
     * @return CustomerCategorySearch
     */
    public function setUserJoin(EmployeeSearchBasic $userJoin): CustomerCategorySearch
    {
