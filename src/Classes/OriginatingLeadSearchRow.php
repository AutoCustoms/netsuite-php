...
class OriginatingLeadSearchRow extends SearchRow {
     ...
     */
    public function setBasic(OriginatingLeadSearchRowBasic $basic): OriginatingLeadSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): OriginatingLeadSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return OriginatingLeadSearchRow
     */
    public function setCustomSearchJoin(CustomSearchRowBasic $customSearchJoin): OriginatingLeadSearchRow
    {
