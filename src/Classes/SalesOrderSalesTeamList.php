...
class SalesOrderSalesTeamList {
     ...
     */
    public function setSalesTeam(SalesOrderSalesTeam $salesTeam): SalesOrderSalesTeamList
    {
     ...
     * @return SalesOrderSalesTeamList
     */
    public function setReplaceAll(bool $replaceAll): SalesOrderSalesTeamList
    {
