...
class CustomSaleSalesTeam {
     ...
     */
    public function setEmployee(RecordRef $employee): CustomSaleSalesTeam
    {
     ...
     * @return CustomSaleSalesTeam
     */
    public function setSalesRole(RecordRef $salesRole): CustomSaleSalesTeam
    {
     ...
     * @return CustomSaleSalesTeam
     */
    public function setIsPrimary(bool $isPrimary): CustomSaleSalesTeam
    {
     ...
     * @return CustomSaleSalesTeam
     */
    public function setContribution(float $contribution): CustomSaleSalesTeam
    {
