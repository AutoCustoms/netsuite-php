...
class InterCompanyJournalEntryLineList {
     ...
     */
    public function setLine(InterCompanyJournalEntryLine $line): InterCompanyJournalEntryLineList
    {
        $this->line[] = $line;
        return $this;
    }
     ...
     * @return InterCompanyJournalEntryLineList
     */
    public function setReplaceAll(bool $replaceAll): InterCompanyJournalEntryLineList
    {
