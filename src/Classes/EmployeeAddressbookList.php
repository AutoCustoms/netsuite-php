...
class EmployeeAddressbookList {
     ...
     */
    public function setAddressbook(EmployeeAddressbook $addressbook): EmployeeAddressbookList
    {
     ...
     * @return EmployeeAddressbookList
     */
    public function setReplaceAll(bool $replaceAll): EmployeeAddressbookList
    {
