...
class CustomerAddressbookList {
     ...
     */
    public function setAddressbook(CustomerAddressbook $addressbook): CustomerAddressbookList
    {
     ...
     * @return CustomerAddressbookList
     */
    public function setReplaceAll(bool $replaceAll): CustomerAddressbookList
    {
