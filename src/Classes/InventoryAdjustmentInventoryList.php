...
class InventoryAdjustmentInventoryList {
     ...
     */
    public function setInventory(InventoryAdjustmentInventory $inventory): InventoryAdjustmentInventoryList
    {
     ...
     * @return InventoryAdjustmentInventoryList
     */
    public function setReplaceAll(bool $replaceAll): InventoryAdjustmentInventoryList
    {
