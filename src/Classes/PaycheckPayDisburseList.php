...
class PaycheckPayDisburseList {
     ...
     */
    protected array $paycheckPayDisburse;
     ...
     */
    public function setPaycheckPayDisburse(PaycheckPayDisburse $paycheckPayDisburse): PaycheckPayDisburseList
    {
     ...
     */
    public function getPaycheckPayDisburse(): array
    {
     ...
     * @return PaycheckPayDisburseList
     */
    public function setReplaceAll(bool $replaceAll): PaycheckPayDisburseList
    {
