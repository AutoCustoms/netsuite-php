...
class GetBudgetExchangeRateRequest {
     ...
     */
    public function setBudgetExchangeRateFilter(BudgetExchangeRateFilter $budgetExchangeRateFilter): GetBudgetExchangeRateRequest
    {
     ...
     */
    public function getBudgetExchangeRateFilter(): BudgetExchangeRateFilter
    {
