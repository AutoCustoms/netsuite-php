...
class CustomizationType {
     ...
     */
    public function setGetCustomizationType(GetCustomizationType $getCustomizationType): CustomizationType
    {
     ...
     */
    public function getGetCustomizationType(): GetCustomizationType
    {
