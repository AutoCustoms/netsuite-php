...
class SearchLongCustomField extends SearchCustomField {
     ...
     */
    public function setSearchValue(int $searchValue): SearchLongCustomField
    {
     ...
     * @return SearchLongCustomField
     */
    public function setOperator(SearchLongFieldOperator $operator): SearchLongCustomField
    {
