...
class InboundShipmentItemsList {
     ...
     */
    protected array $inboundShipmentItems;
     ...
     */
    public function setInboundShipmentItems(InboundShipmentItems $inboundShipmentItems): InboundShipmentItemsList
    {
     ...
     * @return InboundShipmentItemsList
     */
    public function setReplaceAll(bool $replaceAll): InboundShipmentItemsList
    {
