...
class CustomRecordTypeSublistsList {
     ...
     */
    public function setSublists(CustomRecordTypeSublists $sublists): CustomRecordTypeSublistsList
    {
     ...
     * @return CustomRecordTypeSublistsList
     */
    public function setReplaceAll(bool $replaceAll): CustomRecordTypeSublistsList
    {
