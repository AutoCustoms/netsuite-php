...
class ServicePurchaseItemHierarchyVersions {
    /**
     * @var bool
     */
     ...
     */
    public function setIsIncluded(bool $isIncluded): ServicePurchaseItemHierarchyVersions
    {
     ...
     * @return ServicePurchaseItemHierarchyVersions
     */
    public function setHierarchyVersion(RecordRef $hierarchyVersion): ServicePurchaseItemHierarchyVersions
    {
     ...
     * @return ServicePurchaseItemHierarchyVersions
     */
    public function setStartDate(string $startDate): ServicePurchaseItemHierarchyVersions
    {
     ...
     * @return ServicePurchaseItemHierarchyVersions
     */
    public function setEndDate(string $endDate): ServicePurchaseItemHierarchyVersions
    {
     ...
     * @return ServicePurchaseItemHierarchyVersions
     */
    public function setHierarchyNode(RecordRef $hierarchyNode): ServicePurchaseItemHierarchyVersions
    {
