...
class CreditMemoSalesTeam {
     ...
     */
    public function setEmployee(RecordRef $employee): CreditMemoSalesTeam
    {
     ...
     * @return CreditMemoSalesTeam
     */
    public function setSalesRole(RecordRef $salesRole): CreditMemoSalesTeam
    {
     ...
     * @return CreditMemoSalesTeam
     */
    public function setIsPrimary(bool $isPrimary): CreditMemoSalesTeam
    {
     ...
     * @return CreditMemoSalesTeam
     */
    public function setContribution(float $contribution): CreditMemoSalesTeam
    {
