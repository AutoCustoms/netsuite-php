...
class NoteTypeSearchRow extends SearchRow {
     ...
     */
    public function setBasic(NoteTypeSearchRowBasic $basic): NoteTypeSearchRow
    {
        $this->basic = $basic;
        return $this;
    }
     ...
     */
    public function getBasic(): NoteTypeSearchRowBasic
    {
        return $this->basic;
    }
     ...
     * @return NoteTypeSearchRow
     */
    public function setUserJoin(EmployeeSearchRowBasic $userJoin): NoteTypeSearchRow
    {
