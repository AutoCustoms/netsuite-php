...
class ItemFulfillmentPackageList {
     ...
     */
    public function setPackage(ItemFulfillmentPackage $package): ItemFulfillmentPackageList
    {
     ...
     * @return ItemFulfillmentPackageList
     */
    public function setReplaceAll(bool $replaceAll): ItemFulfillmentPackageList
    {
